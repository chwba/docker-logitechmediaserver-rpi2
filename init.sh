...
#cp -f /storage/git/docker/docker-logitechmediaserver-rpi2/*.service /storage/.kodi/addons/service.system.docker/examples
#cp -f /storage/git/docker/docker-logitechmediaserver-rpi2/*.service /storage/.config/system.d/
#cp -f /storage/git/docker/docker-logitechmediaserver-rpi2/*.timer /storage/.kodi/addons/service.system.docker/examples
#cp -f /storage/git/docker/docker-logitechmediaserver-rpi2/*.timer /storage/.config/system.d/
